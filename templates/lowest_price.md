...
**나.** 낙찰자(계약상대자) 선정은 예정가격의 88%이상으로 견적서를 제출한 자 중 최저가격으로 견적서를 제출한 자 순서에 따라 「공직자의 이해충돌방지법」 제12조 제1항 수의계약 체결 제한 사유에 해당하지 아니한 자를 계약상대자로 결정합니다.
...
○ 물품 규격 등 관련사항
- {contact_department}(☎ {contact_phone}, 담당 : {contact_person})
